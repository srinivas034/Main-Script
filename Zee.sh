...
then
	...
	splitnzip.sh -s 150000 -d /mnt/support/package/ /home/amagi/operations/Firmware/Zee_Network/ZeeTv/patchware_CIRD.zip
	printf "\n";
	sleep 10
	printf "\n";
	echo "Patchware_CIRD Transfered Successfully";
	./xfer-file.sh -g uni-ver-sal -d +S200 -c 2 /home/amagi/operations/Firmware/Zee_Network/ZeeTv/patchware_CIRD.zip
	printf "\n";
	echo "It's Done !!!";
	sleep 10
clear
...
splitnzip.sh -s 150000 -d /mnt/support/package/ /home/amagi/operations/Firmware/Zee_Network/ZeeTv/patchware_DIRD.zip
printf "\n";
sleep 10
printf "\n";
echo "Patchware_DIRD Transfered Successfully";
./xfer-file.sh -g uni-ver-sal -d +S200 -c 2 /home/amagi/operations/Firmware/Zee_Network/ZeeTv/patchware_DIRD.zip
printf "\n";
echo "It's Done !!!";
sleep 10
clear
...
splitnzip.sh -s 150000 -d /mnt/support/package/ /home/amagi/operations/Firmware/Zee_Network/ZeeTv/factoryware_3.36.3.zip
printf "\n";
sleep 10
printf "\n";
echo "Factoryware_3.36.3.zip is being Transferring!!!";
./xfer-file.sh -g uni-ver-sal -d +S1200 -c 3 /home/amagi/operations/Firmware/Zee_Network/ZeeTv/factoryware_3.36.3.zip # >  /home/amagi/Session.txt 2>&1
...
splitnzip.sh -s 150000 -d /mnt/support/package/ /home/amagi/operations/Firmware/Zee_Network/ZeeTv/appware_3.36.3.zip
printf "\n";
sleep 10
printf "\n";
echo "Appware_3.36.3.zip is being Transferring";
./xfer-file.sh -g uni-ver-sal -d +S1200 -c 3 /home/amagi/operations/Firmware/Zee_Network/ZeeTv/appware_3.36.3.zip
#printf "\n";
